      ...
      <div className="max-w-4xl mx-auto px-4 py-8 space-y-6">
        ...
        <div className="bg-white rounded-2xl border border-gray-200 shadow-sm p-6 space-y-8">
          ...
          <Section id="users" title="전체 유저">
            <p>가입·미가입 사용자를 검색하고, 상세 정보를 확인하고, 크레딧을 지급하는 페이지입니다.</p>
            ...
            <p>기본 정보, 최초 접속일/접속 횟수, 구독·잔여 크레딧, AI 생성물, 생성 로그, 마케터 제출 내역, 크레딧 지급 이력을 탭으로 봅니다. 마케터 제출 정보는 여기서 직접 수정할 수 있습니다.</p>
            <p className="font-semibold text-gray-900">크레딧 지급</p>
            <ol className="space-y-1">
              <Step>상세 → <b>크레딧 지급</b> 탭으로 이동합니다.</Step>
              <Step>수량, 사유(관리자용), 사용자에게 보여줄 메시지를 입력합니다.</Step>
              <Step><b>지급하기</b>를 누르면 즉시 반영됩니다.</Step>
            </ol>
            <Caution>
              지급은 <b>즉시 잔여 크레딧에 더해지며 되돌릴 수 없습니다.</b> 수량을 꼭 확인하세요.
          ...
          <Section id="terms" title="용어 설명">
            <dl className="space-y-2">
              {[
                ...
                ["크레딧", "AI 생성기의 남은 생성 횟수. 크레딧 지급 = 이 횟수를 더해주는 것."],
          ...
          <Section id="mistakes" title="자주 하는 실수 · 주의">
            <ul className="space-y-1.5 list-disc ml-5">
              <li><b>크레딧 지급은 되돌릴 수 없습니다.</b> 수량을 다시 확인하세요.</li>
