...
import { REVIEWS, quoteLength } from "./reviews";
import "@/lib/ui/motion/motion.css";

export const metadata = {
  title: "미리보기 · AI 인스타그램 마케터",
  // A design preview, not the live front door. Keep it out of search results.
              ...
              >
                {PRODUCTS.map((product) => (
                  <Link
                    ...
                    data-reveal-item
                    href={product.href}
                    className="group grid grid-cols-1 gap-3 border-b py-8 transition-colors duration-300 md:grid-cols-12 md:items-baseline md:gap-6 md:py-10"
                    style={{ borderColor: "var(--ink-line)" }}
                  >
